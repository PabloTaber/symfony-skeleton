 ...
 */
final class Version20240727193122 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Crear la tabla categoria y las relaciones';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id CHAR(36) NOT NULL, CHANGE id id CHAR(36) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, CHANGE id id CHAR(36) NOT NULL');
    }
}
